...
describe("billing service", async () => {
  ...
  describe("#create", () => {
    const options = {"billingId":23,"billingName":"new value","customerId":"new value","billingAddress":"new value","paymentMethod":"new value","transactionId":"new value","transactionDate":"2026-06-25T17:18:12.306Z"};
...
assert.strictEqual(billingCreated.transactionDate.toISOString(), options.transactionDate);
  ...
  describe("#update", () => {
    const options = {"billingId":100,"billingName":"updated value","customerId":"updated value","billingAddress":"updated value","paymentMethod":"updated value","transactionId":"updated value","transactionDate":"2026-06-25T17:18:12.306Z"};
