...
import seederData from "./customer.seeder.json";
...
const CustomerSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerSeederDialogComponent);
